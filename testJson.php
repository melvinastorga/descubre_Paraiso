...
?>
	...
	<div class="demoResultado" >
		<h2 class="col-md-6">resultado</h2>
	</div>
		...
		<div class="row">
			<form method="post" action="rutas.php">
				<div class="col-md-10 mx-auto">
					...
					<div class="form-group row">
						<div class="col-sm-6">
							<label for="inputCity">Categoría</label> <select
								id="categorySearch" class="form-control">
	...
	<script
		...
		crossorigin="anonymous"></script>
	<script src="js/testRutas.js"></script>
